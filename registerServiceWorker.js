...
export function register(config) {
  if ('serviceWorker' in navigator) {
    ...
    const publicUrl = new URL(CLIENT_HOST, window.location.href);

    if (publicUrl.origin !== window.location.origin) {
      // Our service worker won't work if CLIENT_HOST is on a different origin
    ...
    window.addEventListener('load', () => {
      const swUrl = `${CLIENT_HOST}/service-worker.js`;
